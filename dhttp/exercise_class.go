...
func (s *HTTPServer) handleExerciseClassGet(w http.ResponseWriter, r *http.Request) {
	...
	response, err := s.client.ExerciseClass(context.Background(), &proto.ExerciseClassRequest{
